...
#   sbatch --partition=rvs --account=mpp --gres=${CLUSTER_GPU_GRES_1} slurm/submit_al_tabpfn.sh
#
...
echo "[params] AL_OUTPUT_DIR=${AL_OUTPUT_DIR:-/ptmp/jwuerzin/active_learning_tabpfn_output_slurm}"
