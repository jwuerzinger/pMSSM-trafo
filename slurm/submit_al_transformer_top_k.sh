...
echo "[params] AL_OUTPUT_DIR=${AL_OUTPUT_DIR:-/ptmp/jwuerzin/output/active_learning_output_top_k_slurm_${TIMESTAMP}}"
...
"${PYTHON}" active_learning.py \
    ...
    --output-dir "${AL_OUTPUT_DIR:-/ptmp/jwuerzin/output/active_learning_output_top_k_slurm_${TIMESTAMP}}" \
    --early-stopping \
